    ...
    <div className="flex-1 flex overflow-hidden">
      ...
      >
        ...
        {(ocrRunning || ocrText !== null) && (
          ...
          >
            <div
              className="w-[34rem] max-w-[90vw] bg-zinc-900 border border-zinc-700 rounded-xl p-4 flex flex-col gap-3"
...
function ResizeModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={onCancel}>
      <div
        className="w-72 bg-zinc-900 border border-zinc-700 rounded-xl p-4 flex flex-col gap-3"
        onClick={(e) => e.stopPropagation()}
      >
